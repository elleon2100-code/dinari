...
const ARTICLE_SLUGS = [
  ...
  'atraso-de-un-dia',
  'ansiedad-financiera',
  'cancelar-tarjeta-de-credito',
  'cat-vs-tasa',
  'como-ahorrar-si-ganas-poco',
  'como-negociar-deudas',
  'consolidar-deudas',
  'crear-un-presupuesto',
  'cuantas-tarjetas-tener',
  'errores-deuda-eterna',
  'endeudamiento-emocional',
  'gastos-hormiga',
  'fondo-de-emergencia',
  'intereses-rotativos',
  'interes-compuesto-en-contra',
  'metodo-avalancha',
  'organizar-multiples-deudas',
  'por-que-baja-mi-score-crediticio',
  'porcentaje-de-uso-peligroso',
  'sesgos-psicologicos-bancos',
];
